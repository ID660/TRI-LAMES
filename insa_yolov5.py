...
Original file is located at
    https://colab.research.google.com/drive/1D8trpSLS7J6MdI81uJacg5VBuzWYV0_N
...
!python detect.py --weights runs/train/exp/weights/last.pt --img 640 --conf 0.25 --source ../T.mp4
